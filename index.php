...
case "index":
    include_once "controllers/perfumeria/index.control.php";
    die();
case "nosotros":
      include_once "controllers/perfumeria/nosotros.control.php";
      die();
case "mujeres":
        include_once "controllers/perfumeria/mujeres.control.php";
        die();
case "hombres":
          include_once "controllers/perfumeria/hombres.control.php";
          die();
case "servicios":
            include_once "controllers/perfumeria/servicios.control.php";
            die();


//servicios
case "oficina":
  include_once "controllers/perfumeria/servicios/oficina.control.php";
  die();
case "actividades":
    include_once "controllers/perfumeria/servicios/actividades.control.php";
    die();

//mujeres
case "infantiles":
  include_once "controllers/perfumeria/mujeres/infantiles.control.php";
  die();
case "juvenil":
  include_once "controllers/perfumeria/mujeres/juvenil.control.php";
  die();
case "familiar":
  include_once "controllers/perfumeria/mujeres/familiar.control.php";
  die();
